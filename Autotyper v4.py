...
cancelinfo = ttk.Label(text="to cancel move mouse to right corner")

#screen element locations
infowrite.grid(row=1,column=1)
labeltext.grid(row=2,column=1)
inputtext.place(x=0,y=40)
cusamo.place(x=0,y=70)
entercheckbox.place(x=0,y=90)
amounttorepeat.place(x=10,y=95,width=270)
startbutton.place(x=0,y=170)
cancelinfo.place(x=80,y=172)
